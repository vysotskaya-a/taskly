...
const (
	...
	TaskService_GetTasksByProjectID_FullMethodName = "/task_v1.TaskService/GetTasksByProjectID"
...
type TaskServiceClient interface {
	...
	GetTasksByProjectID(ctx context.Context, in *GetTasksByProjectIDRequest, opts ...grpc.CallOption) (*GetTasksByProjectIDResponse, error)
...
func (c *taskServiceClient) GetTasksByProjectID(ctx context.Context, in *GetTasksByProjectIDRequest, opts ...grpc.CallOption) (*GetTasksByProjectIDResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetTasksByProjectIDResponse)
	err := c.cc.Invoke(ctx, TaskService_GetTasksByProjectID_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TaskServiceServer interface {
	...
	GetTasksByProjectID(context.Context, *GetTasksByProjectIDRequest) (*GetTasksByProjectIDResponse, error)
...
func (UnimplementedTaskServiceServer) GetTasksByProjectID(context.Context, *GetTasksByProjectIDRequest) (*GetTasksByProjectIDResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetTasksByProjectID not implemented")
}
...
func _TaskService_GetTasksByProjectID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetTasksByProjectIDRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TaskServiceServer).GetTasksByProjectID(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TaskService_GetTasksByProjectID_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TaskServiceServer).GetTasksByProjectID(ctx, req.(*GetTasksByProjectIDRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TaskService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetTasksByProjectID",
			Handler:    _TaskService_GetTasksByProjectID_Handler,
		},
		{
